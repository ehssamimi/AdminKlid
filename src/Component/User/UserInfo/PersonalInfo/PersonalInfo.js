...
const  name ="احسان صمیمی راد ";
const  phoneNumber ="09112561701 ";
const  grade =" دوازدهم";
const  field ="ریاضی و فیزیک ";
            ...
            <div className="w-100 h-100 ow m-0">
                <div className="row m-0  w-100    ">
                    ...
                    <div className="w-100 mt-3 brt-s row m-0">
                        <LabelValueRow label={"کد احراز هویت فردی"} value={1944} className="col-6   justify-content-start FsFooterLogin "/>
                        <LabelValueRow label={"کد احزاز هویت والد"} value={5622} className="col-6  justify-content-start FsFooterLogin "/>
                    </div>

...
import ItemCardMain from "../../PreviewContentComponent/ItemCardMain/ItemCardMain";
import AddItem from "../../AddContentComponent/AddItem/AddItem";
        ...
        <div>
            {
                isLoader ? <div className='d-flex justify-content-center align-items-center'>
                    ...
                    <div className="w-100"  >
                        ...
                        <AddItem {...props} id={params.id} Lesson_index={params.index} Lesson_name={params.lesson}  Teacher={params.teacher} TeacherIndex={params.TeacherIndex} chapterIndex={params.chapterIndex}  chapter={params.chapter} index={params.itemIndex} updateContent={getData}/>
